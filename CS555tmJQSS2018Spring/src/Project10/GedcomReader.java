...
import java.time.Period;
 ...
 public class GedcomReader { 
    ...
    public List<List<String>> getUpcomingAnniversary() {
     ...
     public void sort() {
    	 for (Family f : families)
    		 Collections.sort(f.getChildren());
     }
      ...
      public static void main(String[] args) { 
        ...
        List<String> allnameswithbirthday = new ArrayList<>();
         ...
         if ( !duplicateNamesBd.isEmpty() ) { 
        	...
        	System.out.println("US23: All the names and dates are unique");
        //US23 end
 		...
 		List<Individual> list = gr.getLivingSingles30plus();
 		System.out.println("\nLIST: US31: List living singles");
 		if (list.size() == 0) System.out.println("There are no living singles");
 		else {
 			System.out.println("+-----+-------------------+---------+---------------+");
 			System.out.println("| ID  | Name              | Gender  | Birthday      |");
 			System.out.println("+-----+-------------------+---------+---------------+");
